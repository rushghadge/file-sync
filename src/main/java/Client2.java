...
public class Client2 implements Runnable{
    ...
    public Client2(String threadName){
...
try {
    int changedBlock = FileComparison.compareFileByByte(Path.of(Constants.CLIENT_FILE_ROOT2 + "\\" + watcher.modifiedFile.toString()),
    ...
    public static void main(String[] args) throws IOException {
        ...
        int clientNum = 2;// Integer.parseInt(args[0]);
        ...
        sender.println("2\nSTARTING\nSTOP");
        // Create threads
        Thread watcher = new Thread(new Client2("watcher"));
        Thread pollingAgent = new Thread(new Client2("pollingAgent"));
        // Start them
        watcher.start();
//        pollingAgent.start();
